...
import { CapitalPoolData } from 'hooks/useCapitalPoolsLegacy';
...
import { getVouchStakingContractLegacy, getVouchStakingContractAbi, getStakingRewardPoolContractLegacy, getCapitalPoolContractAbi } from 'config/contract';

interface CapitalPoolCardLegacyProps {
...
export const CapitalPoolCardLegacy: React.FC<CapitalPoolCardLegacyProps> = ({
  poolData,
  checkVplsAllowance,
  onApproveVpls,
  onDepositVpls,
  ...
  const [selectedTab, setSelectedTab] = useState<'stake' | 'unstake'>('unstake');
