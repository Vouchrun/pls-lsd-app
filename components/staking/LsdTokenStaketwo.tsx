...
import { getThresholdAPR, getTokenName } from "utils/configUtils";
  ...
  return (
    <div>
      <div className="h-[1.07rem] mt-[.18rem] pt-[.24rem] mx-[.24rem] bg-[#edece3] dark:bg-[#111111] rounded-[.3rem]">
        <div className="mx-[.12rem] flex items-start">
          ...
          <div className="flex-1 flex justify-start flex-col pl-[.14rem]">
            ...
            <div className="mt-[.1rem] flex items-center justify-center text-[.14rem]">
      ...
      >
        ...
        >
          <div className="text-center leading-[150%] text-color-text2">
            Exchange Rate
          </div>
      ...
      <div className="mt-[20px] flex justify-center mb-[20px]">
        <div className="h-[45px] w-[160px] CustomButton_button__wfQ6z px-[.28rem] cursor-pointer mx-[.24rem] active:opacity-50 rounded-[50px] p-0">
          <div className="">
            <div className="flex items-center">Stake</div>
          </div>
        </div>
        <div className=" p-0 h-[45px] w-[160px] CustomButton_button__wfQ6z px-[.28rem] cursor-pointer mx-[.24rem] active:opacity-50 rounded-[50px]">
          <div className="">
